    ...
    return (
        <>
            ...
            <div className="bg-banner relative">
                {/* navbar */}
                <nav
                    className='flex justify-between items-center pt-5 px-10 '>
                    {/* logo */}
                    ...
                    <div className='pr-8 md:block  hidden'>
                        <ul className=" flex flex-row gap-5 text-white font-bold">
                            <li className="underline-hover-effect cursor-pointer">About</li>
                            <li className="underline-hover-effect cursor-pointer">Careers</li>
                            <li className="underline-hover-effect cursor-pointer">Events</li>
                            <li className="underline-hover-effect cursor-pointer">Products</li>
                            <li className="underline-hover-effect cursor-pointer">Support</li>
                        </ul>
                    </div>
                ...
                {/* text box */}
                <div className=" mt-28 sm:mt-32 px-10 flex justify-center sm:justify-start">
                    <div className=" w-96 h-48 sm:h-60 border-2 border-white">
                        <div className=" p-4 sm:p-8 uppercase text-white text-4xl sm:text-5xl ">
